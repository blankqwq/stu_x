...
@endsection
    ...
    <div class="col-md-9">
        <div class="box box-primary">
            ...
            <form action="{{route('homework.store',$classe)}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right"  data-placement="top"id="reservation" name="time">
                    </div>
                    <!-- /.input group -->
                </div>
                <div class="form-group">
