<div class="col-md-9">
           ...
           $('#chart_box').keydown(function (event) {
               if (event.keyCode == 13){
                   ...
                   if(text==null|| text==''){
                       ...
                       var data={'type':'message','content':text,'class_id':{{$classe->id}},'user_id':{{$user->id}}};
                       websocket.send(JSON.stringify(data));
                   }
               }
           });
    ...
    <div class="box box-success">
        <div class="box-header ui-sortable-handle" style="cursor: move;">
            ...
            <div class="box-tools pull-right" data-toggle="tooltip" title="" data-original-title="Status">
                <div class="btn-group" data-toggle="btn-toggle">
                    ...
                    <button type="button" id="chart_quit" class="btn btn-default btn-sm"><i class="fa fa-square text-red"></i></button>
                </div>
            </div>
        </div>
        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 500px;">
            ...
            </div><div class="slimScrollBar" style="background: rgb(0, 0, 0); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 224.82px;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
